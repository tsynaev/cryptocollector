    ...
    ILogger<DeribitExchange> logger) : IExchange
{
    ...
    private static ExchangeTrade MapTrade(DeribitTrade trade) =>
        new()
        {
            ...
            Iv = trade.Iv,
            TickDirection = trade.TickDirection?.ToString(System.Globalization.CultureInfo.InvariantCulture),
            ...
            BlockRfqId = trade.BlockRfqId?.ToString(System.Globalization.CultureInfo.InvariantCulture),
